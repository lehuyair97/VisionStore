...
exports.changePassword = authenticateToken(async (req, res) => {
  try {
    const { id } = req.params;
...
exports.updateInfo = authenticateToken(async (req, res) => {
  try {
    const { id } = req.params;
...
exports.deleteUser = authenticateToken(async (req, res) => {
  try {
    const { id } = req.params;
