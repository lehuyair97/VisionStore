...
class Products extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (controllerCategory.categoryList.isNotEmpty) {
      controller.categoryId.value =
          controllerCategory.categoryList.first.id ?? '';
      controller.fetchProductsGroupedByBrand(
          controller.categoryId.value); // Gọi hàm để lấy sản phẩm
    }
                                  ...
                                  Expanded(
                                    ...
                                    child: Card(
                                      ...
                                      child: SfDataPager(
                                        ...
                                        itemWidth: 50,
                                        pageCount:
                                            controller.productGridRows.length /
                                                7,
                                        visibleItemsCount: 7,
                                        delegate:
