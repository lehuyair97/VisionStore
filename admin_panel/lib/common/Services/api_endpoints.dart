...
class ApiEndpoints {
  ...
  static String getProductById(String productId) => "${Config.baseUrl}/products/$productId";
  static String updateProduct(String productId) => "${Config.baseUrl}/products/$productId";
  static String deleteProduct(String productId) => "${Config.baseUrl}/products/$productId";
